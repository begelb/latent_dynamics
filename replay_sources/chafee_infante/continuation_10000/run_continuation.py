...
ARCHIVE_DIR = PROJECT_ROOT / "archive" / "marcio" / "scripts"
...
def load_and_validate_inputs() -> tuple[NDArray[np.float64], NDArray[np.int64], NDArray[np.float64], dict[str, Any]]:
    ...
    provenance = {
        ...
        "source_hashes": {
            "autoencoder_model.py": sha256_file(ARCHIVED_MODEL_SOURCE),
            "generate_attractor_basin_data.py": sha256_file(ARCHIVED_LABEL_SOURCE),
